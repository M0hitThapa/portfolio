...
const About = () => {
  ...
  return (
    <section className="sm:px-10 px-5 " id="about">
          ...
          <div className="w-full h-full border border-black-300 bg-black-200 rounded-lg sm:p-7 p-4 flex flex-col gap-5">
            ...
            <div>
              ...
              <p className=" text-[#afb0b6] text-base font-generalsans">
                With Eager To Learn, I have honed my skills in both frontend and backend dev, creating dynamic
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="w-full h-full border border-black-300 bg-black-200 rounded-lg sm:p-7 p-4 flex flex-col gap-5">
            ...
            <div>
              ...
              <p className="text-[#afb0b6] text-base font-generalsans">
                I am comfortable in a variety of languages, frameworks, and tools that allow me to build robust and scalable
                applications
              </p>
            </div>
          </div>
