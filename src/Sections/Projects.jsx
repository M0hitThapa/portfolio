...
const Projects = () => {
  ...
  return (
    <section className=" flex flex-col items-center sm:px-10 px-5 my-20 text-slate-200 text-lg font-black font-mono">
      <p className="head-text">Currently Working On</p>

      <div className="grid lg:p-30  grid-cols-1 mt-12 gap-5 w-full">
